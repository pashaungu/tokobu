		...
		<div class="container">
			...
			<div class="row product-lists">
				...
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="{{ url('/single-product') }}"><img src="{{ asset('assets/img/products/product-img-4.jpg') }}" alt=""></a>
						</div>
						<h3>Avocado</h3>
				...
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="{{ url('/single-product') }}"><img src="{{ asset('assets/img/products/product-img-5.jpg') }}" alt=""></a>
						</div>
						<h3>Green Apple</h3>
				...
				<div class="col-lg-4 col-md-6 text-center strawberry">
					<div class="single-product-item">
						<div class="product-image">
							<a href="{{ url('/single-product') }}"><img src="{{ asset('assets/img/products/product-img-6.jpg') }}" alt=""></a>
						</div>
						<h3>Strawberry</h3>
				...
				<div class="col-lg-3 col-md-6">
					<div class="footer-box pages">
						...
						<ul>
							...
							<li><a href="{{ url('/about') }}">About</a></li>
							<li><a href="{{ url('/services') }}">Shop</a></li>
							<li><a href="{{ url('/news') }}">News</a></li>
							<li><a href="{{ url('/contact') }}">Contact</a></li>
						</ul>
					</div>
